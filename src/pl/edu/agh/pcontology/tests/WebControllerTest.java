...
public class WebControllerTest {
	...
	public static void main(String[] args) {
		...
		EspacenetController controller = new EspacenetController.Builder(
				"crawled_sites", 1).maxDepth(2).maxPages(1000)
				.politnessDelay(1000).resumableCrawling(false)
				.defineQuery("WO2013154454").build();
